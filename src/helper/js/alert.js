...
function check_add_user() {
  var pass = true;
  var username = document.querySelector("#username_add");
  var password = document.querySelector("#password_add");
  var confirmPassword = document.querySelector("#confirmPassword_add");
  var role_id = document.querySelector("#role_id_add");
